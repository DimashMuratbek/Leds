...
void setup() {
  ...
  My_timer1 = timerBegin(0, 80, CHANGE);
  My_timer2 = timerBegin(1, 80, CHANGE);
  My_timer3 = timerBegin(2, 80, CHANGE);
  My_timer4 = timerBegin(3, 80, CHANGE);
  ...
  timerAlarmWrite(My_timer3, 1100000, true);
  timerAlarmWrite(My_timer2, 1200000, true);
  timerAlarmWrite(My_timer1, 1300000, true);
